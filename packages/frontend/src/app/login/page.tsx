        ...
        >
            ...
            >
                ...
                <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                    ...
                    <TextField
                        ...
                        InputProps={{
                            endAdornment: (
                                ...
                                >
                                    <VisibilityIcon 
                                        className={`${showPassword ? 'text-secondaryGreen' : 'text-mediumGray text-opacity-50'}`}
                                    />
                                </Button>
                            ),
                        }}
                    ...
                    <Typography variant="body1" style={{ margin: '1rem 0', color: '#757575' }}>
                        ou
                    </Typography>
                </Box>
                ...
                >
                    ...
                    <Typography>
                        Não está cadastrado? <Link href='/logon'>Cadastre-se aqui! <NorthEastIcon /></Link>
                    </Typography>
                </Box>
            </Container>
        </div>
